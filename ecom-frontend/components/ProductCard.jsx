...
<button disabled={!isAvailable ||btnLoader} onClick={()=>{}}  className={`bg-blue-500 text-white px-4 py-2 rounded-lg  items-center transition-colors duration-600 w-36 flex justify-center  ${isAvailable ? "opacity-100 hover:bg-blue-600" : "opacity-70 cursor-not-allowed"}`} >
    
   <FaShoppingCart className="mr-2" /> {isAvailable ? "Add to Cart": "Stock Out"}</button>

        </div>

</div>
<ProductViewModel open={openProductViewModel}
